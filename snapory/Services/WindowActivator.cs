...
/// that is not currently active (as happens with a global hotkey). Windows
/// normally refuses to let a background process steal focus; the accepted
/// workaround is to briefly attach our thread's input to the thread that owns
/// the foreground window, make the call, then detach again.
/// </summary>
